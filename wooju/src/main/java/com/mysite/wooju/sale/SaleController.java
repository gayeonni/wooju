...
public class SaleController {
    ...
    public String findcategoryByCategoryid2(Model model, @PathVariable("id") Integer id, @RequestParam(value="page", defaultValue="0") int page)
    {
       Category category = this.categoryService.getCategory2(id);
    ...
    @PreAuthorize("isAuthenticated()")
    @PostMapping("/create")
    public String saleCreate(@ModelAttribute("saleForm")@Valid SaleForm saleForm,
                                 BindingResult bindingResult, Principal principal, Object Category) throws IOException {
        ...
        this.saleService.create(saleForm.getSubject(), saleForm.getContent(), siteUser, saleForm.getCategory(), saleForm.getPrice(), imageFiles);
    ...
    public String saleModify(@Valid SaleForm saleForm, BindingResult bindingResult, 
        ...
        this.saleService.modify(sale, saleForm.getSubject(), saleForm.getContent(), saleForm.getCategory(), saleForm.getPrice());
